...
logs:
 ...
 # OperationsManager Log may be listed as either with or without a space. Choose the option for your environment.  Use Powershell to enumerate the foramt.
  - name: scom
    winlog: 
       #channel: Operations Manager
       channel: OperationsManager
...
```
3. If you get this error: `error while loading shared libraries: libssl.so.1.1: cannot open shared object file: No such file or directory` update OpenSSL to 1.1.0 or higher. 
